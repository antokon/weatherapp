...
public class Function  {
    ...
    private static final String OPEN_WEATHER_MAP_API = "f157da38b1b5376d3ae1b1a8c4b06426";
...
//                    preferences.edit()
//                            .putString("temperature", String.format("%.2f", main.getDouble("temp")))
//                            .apply();



                    String city = json.getString("name").toUpperCase(Locale.ITALY) + ", " + json.getJSONObject("sys").getString("country");
                    String description = details.getString("description").toUpperCase(Locale.ITALY);
